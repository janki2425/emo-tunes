                ...
                {!isLoggedIn ? (
                    <>
                        <button
                            ...
                            className='px-3 py-2 border-[2px] border-[#DDD0C8] rounded-[16px] text-[#DDD0C8] hover:text-[#d9b49d] hover:border-[#d9b49d] P-20 font-[600] transition-all duration-300'
                        >
                            Sign Up
                        </button>
                        <button 
                            onClick={handleSignIn}
                            className='px-3 py-2 border-[2px] border-[#DDD0C8] bg-[#DDD0C8] hover:bg-[#d6bdad] text-[#265767] P-20 font-[600] rounded-[16px] transition-all duration-300'
                        >
                            Sign In
                        </button>
                    </>
